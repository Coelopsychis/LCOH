...
$$LCOH =\frac{\text{jährliche Investitions- und Finanzierungskosten} + \text{OPEX} + \text{Stromkosten} + \text{Stacktausch} - \text{Förderungen} - \text{Erlöse}}{\text{jährliche H₂-Produktion}}$$
